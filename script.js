...
window.Icons = {
  logo: (width = 30, height = 30) => `
    <img src="./images/cleanpoint_logo_modern_1770050522462.png" alt="CleanPoint Logo" style="width: ${width}px; height: ${height}px; object-fit: contain;">
  `,
          ...
          <div class="content-right">
             <div class="diamond-grid">
                <div class="diamond-item d1">
                   <img src="./src/assets/images/cleaner_sink_realistic_1770051457068.png" alt="Detail Cleaning">
                </div>
                <div class="diamond-item d2">
                   <img src="./src/assets/images/cleaners_diamond_realistic_1770051442264.png" alt="Office Cleaning">
                </div>
